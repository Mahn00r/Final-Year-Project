...
namespace Kinect2Sample
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string handsAboveHeadGestureName = "Hello_Right";
        private readonly string HowAreYouGestureName = "HowAreYou";
        ...
        public GestureDetector(KinectSensor kinectSensor, GestureResultView gestureResultView)
        {
            ...
            using (VisualGestureBuilderDatabase database = new VisualGestureBuilderDatabase(this.gestureDatabase))
            {
                ...
                {
                    if (gesture.Name.Equals(this.HowAreYouGestureName))
                    {
        ...
        public GestureResultView GestureResultView
        {
            ...
            using (VisualGestureBuilderFrame frame = frameReference.AcquireFrame())
            {
                if (frame != null)
                {
                    ...
                    if (discreteResults != null)
                    {
                        ...
                        {
                            if (gesture.Name.Equals(this.HowAreYouGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                if (result != null)
                                {
                                    ...
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, HowAreYouGestureName);
                            ...
                            if (gesture.Name.Equals(this.handsAboveHeadGestureName) && gesture.GestureType == GestureType.Discrete)
                            {
                                ...
                                {
                                    // update the GestureResultView object with new gesture result values
                                    this.GestureResultView.UpdateGestureResult(true, result.Detected, result.Confidence, handsAboveHeadGestureName);
                                }
                            }
                        }
                    }
