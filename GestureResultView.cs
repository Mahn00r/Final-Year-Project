...
namespace Kinect2Sample
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        public GestureResultView(int bodyIndex, bool isTracked, bool detected, float confidence, string gesturename2)
        {
            this.BodyIndex = bodyIndex;
            this.IsTracked = isTracked;
            this.Detected = detected;
            this.Confidence = confidence;
            this.gestureName = gesturename2;
        ...
        public void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, string gestureName1)
        {

            gestureName = gestureName1;
